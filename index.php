    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logosai.png" height="40px"></a>
                </div>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                ...
                </div><div id="contact" class="contact">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title">
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
				...
				<p class="pull-right small"><a href="adminlogin.php">admin</a></p>
                            ...
                            <a href="index.php"> <img src="assets/img/logosai.png" alt="logo" /></a>
                            
<p class="pull-right small"><li>
                                    <a href="#"><img src="assets/icon/loc.png" alt="#" /></a>lingampally 9th Block,hyderabad-560019
                                    <br>District Fund Road</li>
                                <li>
                                    <a href="#"><img src="assets/icon/email.png" alt="#" /></a>saihospital@gmail.com </li>
                                <li>
                                    <a href="#"><img src="assets/icon/call.png" alt="#" /></a>+919848555777</li></p>
